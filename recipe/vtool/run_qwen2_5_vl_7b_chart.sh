...
MODEL_PATH=${MODEL_PATH:-/verifier-agent/checkpoints/VTool-7B}
TRAIN_FILE=${TRAIN_FILE:-/verifier-agent/refocus_chart/train.parquet}
...
ACTOR_MAX_TOKEN_LEN_PER_GPU=${ACTOR_MAX_TOKEN_LEN_PER_GPU:-20480}
INFER_MAX_TOKEN_LEN_PER_GPU=${INFER_MAX_TOKEN_LEN_PER_GPU:-20480}
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name=7b_chart_fp16 \
