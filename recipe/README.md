...
- [vtool](https://github.com/verl-project/verl-recipe/tree/main/vtool): Multimodal refocus-agent RL recipe with a custom image-editing loop and final-answer reward.
